;              
CREATE USER IF NOT EXISTS SA SALT 'fef282576b5d6ad0' HASH '2c2a30bbb2b6bb82dc6ce9f553390ed18dc8dba186a675b1e876185e193b7a7e' ADMIN;            
...
ALTER TABLE PUBLIC.PAYMENT ADD CONSTRAINT PUBLIC.FK_QAX5EFRRK39SFSE3D1B3AKG8O FOREIGN KEY(AUTHOR) REFERENCES PUBLIC.USER(ID) NOCHECK;          
...
ALTER TABLE PUBLIC.NEWS ADD CONSTRAINT PUBLIC.FK_LQ5AQ3CP8YEUN8DW0955CJ3ER FOREIGN KEY(AUTHOR) REFERENCES PUBLIC.USER(ID) NOCHECK;             
...
ALTER TABLE PUBLIC.EVENT ADD CONSTRAINT PUBLIC.FK_P1XP0T0V19CW3MN54MXPMKS9S FOREIGN KEY(AUTHOR) REFERENCES PUBLIC.USER(ID) NOCHECK;            
ALTER TABLE PUBLIC.NEWS_VISIT ADD CONSTRAINT PUBLIC.FK_EQE0N6BNWSQ3JFPNBICF9XPH5 FOREIGN KEY(VISITOR) REFERENCES PUBLIC.USER(ID) NOCHECK;      
...
ALTER TABLE PUBLIC.DOCUMENT_DIR ADD CONSTRAINT PUBLIC.FK_G42781VLON018TH6HGOAMTCIS FOREIGN KEY(AUTHOR) REFERENCES PUBLIC.USER(ID) NOCHECK;     
ALTER TABLE PUBLIC.DOCUMENT_RECEIPT_RECEIPT_USERS ADD CONSTRAINT PUBLIC.FK_2SROTTYJTK44BV63YRM3D3NB1 FOREIGN KEY(RECEIPT_USERS) REFERENCES PUBLIC.USER(ID) NOCHECK;            
ALTER TABLE PUBLIC.EVENT ADD CONSTRAINT PUBLIC.FK_9FV2MP096G1P81RTHS7XWBO8X FOREIGN KEY(MASTER_USER) REFERENCES PUBLIC.USER(ID) NOCHECK;       
...
ALTER TABLE PUBLIC.USER_GROUPS ADD CONSTRAINT PUBLIC.FK_7P11HW85TJ3EKPBPMVMN4575A FOREIGN KEY(USER) REFERENCES PUBLIC.USER(ID) NOCHECK;        
ALTER TABLE PUBLIC.DOCUMENT ADD CONSTRAINT PUBLIC.FK_BAIN1NQ2E3EFG3UQX3W156V6 FOREIGN KEY(AUTHOR) REFERENCES PUBLIC.USER(ID) NOCHECK;          
ALTER TABLE PUBLIC.DOCUMENT_RECEIPT_RETURN_USERS ADD CONSTRAINT PUBLIC.FK_ECN85BFO25HQ8JSLTJXRG55NF FOREIGN KEY(RETURN_USERS) REFERENCES PUBLIC.USER(ID) NOCHECK;              
ALTER TABLE PUBLIC.MESSAGE_RECIPIENT ADD CONSTRAINT PUBLIC.FK_LBY2NF1YV6XU1JT8KMHTXFCPJ FOREIGN KEY(RECIPIENT) REFERENCES PUBLIC.USER(ID) NOCHECK;             
ALTER TABLE PUBLIC.BUILD_PROJECT ADD CONSTRAINT PUBLIC.FK_2G1B90GK9LU860OVQ7V5J1MH FOREIGN KEY(AUTHOR) REFERENCES PUBLIC.USER(ID) NOCHECK;     
...
ALTER TABLE PUBLIC.USER_ROLES ADD CONSTRAINT PUBLIC.FK_OANCH5NIXY8AA46Y2JEXKVO5W FOREIGN KEY(USER) REFERENCES PUBLIC.USER(ID) NOCHECK;         
...
ALTER TABLE PUBLIC.MESSAGE ADD CONSTRAINT PUBLIC.FK_A3KM2KV42I1XU571TA911F9DC FOREIGN KEY(SENDER) REFERENCES PUBLIC.USER(ID) NOCHECK;          
...
ALTER TABLE PUBLIC.NEWS_TYPE ADD CONSTRAINT PUBLIC.FK_RSLG6S7V2EP8WXHB9DROMY9J3 FOREIGN KEY(AUTHOR) REFERENCES PUBLIC.USER(ID) NOCHECK;        
...
ALTER TABLE PUBLIC.EVENT_PARTICIPANTS ADD CONSTRAINT PUBLIC.FK_T2YJ8KBTB6UG70OE00T14KWWR FOREIGN KEY(PARTICIPANTS) REFERENCES PUBLIC.USER(ID) NOCHECK;         
ALTER TABLE PUBLIC.USER_LOG ADD CONSTRAINT PUBLIC.FK_6QWNAXINEVILWO3I8KU9OLS14 FOREIGN KEY(AUTHOR) REFERENCES PUBLIC.USER(ID) NOCHECK;         
...
ALTER TABLE PUBLIC.FILE_INFO ADD CONSTRAINT PUBLIC.FK_L0KKREOE9OL38DKT0W6DTWB2E FOREIGN KEY(AUTHOR) REFERENCES PUBLIC.USER(ID) NOCHECK;        
...
ALTER TABLE PUBLIC.CONTRACT_DOCUMENT ADD CONSTRAINT PUBLIC.FK_8IX8SDIRVWIKLJ09QIMNLN177 FOREIGN KEY(AUTHOR) REFERENCES PUBLIC.USER(ID) NOCHECK;
...
ALTER TABLE PUBLIC.NOTIFICATION ADD CONSTRAINT PUBLIC.FK_HKK6SA4DES0NR2XB8N036HF23 FOREIGN KEY(USER) REFERENCES PUBLIC.USER(ID) NOCHECK;       
ALTER TABLE PUBLIC.USER_RESOURCES ADD CONSTRAINT PUBLIC.FK_NYHEA9VUAVCE6FVQXG4USPCQE FOREIGN KEY(USER) REFERENCES PUBLIC.USER(ID) NOCHECK;     
...
ALTER TABLE PUBLIC.EVENT_PROGRESS ADD CONSTRAINT PUBLIC.FK_G5FBSGEC01IR6XL5XO922LHTP FOREIGN KEY(USER) REFERENCES PUBLIC.USER(ID) NOCHECK;     