    ...
    public void enableSessionValidation() {
        ...
        try {
        	 SimpleTrigger trigger = newTrigger()
                     ...
                     .withIntervalInSeconds(SimpleTrigger.REPEAT_INDEFINITELY).repeatForever())
                     .build();
//            SimpleTrigger trigger = new SimpleTrigger(getClass().getName(),
//                    Scheduler.DEFAULT_GROUP,
//                    SimpleTrigger.REPEAT_INDEFINITELY,
//                    sessionValidationInterval);
            JobDetail detail = newJob(QuartzSessionValidationJob.class).withIdentity(JOB_NAME, Scheduler.DEFAULT_GROUP) .build();
