...
public class AliTest implements Runnable {
    private static StorageServiceProvider storageServiceProvider = StorageServiceProvider.ALI;
    ...
    private static List<AliTest> localFileSyncList = new ArrayList<AliTest>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        accessToken = "a7OZhIQTDgIemjwz";
        secretToken = "moAT09EaU1Pz4d4JuA9GZ1mwRw1aQn";
        endPoint = "http://oss-cn-beijing.aliyuncs.com";
        bucketName = "vr-data-test";
        rootDirPath = "/home/abel/t";
        threadNum = 8;
        ...
        for (int i = 0 ; i < threadNum ; i++) {
        	AliTest localFileSync = new AliTest();
        ...
        processDir(rootDir);
        for (AliTest localFileSync : localFileSyncList) {
            localFileSync.stop();
        }
    ...
    private static CloudFileOperator getCloudFileOperator() {
        ...
        return CloudFileManager.getFileOperator(storageServiceProvider, new CloudFileManager.InitPackage(bucketName, authKey,endPoint));
    }
